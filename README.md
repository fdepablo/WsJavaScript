...
Este workspace se realizo con Visual Studio Code (VSC) como IDE, aunque se puede utilizar cualquier otro.
...
2. Parar abrir las páginas html, boton derecho sobre el fichero html -> open with -> Web Browser
